...
export default function App() {
  ...
  // Called when user generates a new resume
  const handleNewResume = (url: string) => {
    ...
    setRecentResumes(prev => {
      ...
      return updated.slice(-3); // keep only 3 most recent
    });
  };
      ...
      case 'resume-builder':
        return (
          <ResumeBuilder
            user={user!}
            onNavigate={setCurrentPage}
            onResumeGenerated={handleNewResume}
          />
        );
