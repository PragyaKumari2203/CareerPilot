    ...
    async function getStats() {
      try {
        const res = await fetch(
          `http://localhost:5001/api/stats?userId=${user.authUserId}`
        );
    ...
    async function fetchRecentApplications() {
      try {
        ...
        const response = await fetch(
          `http://localhost:5001/api/applications?userId=${userId}`,
          {
            credentials: "include",
            headers: {
      ...
      <div className="p-8">
          ...
          <div className="flex flex-col sm:flex-row items-start justify-between gap-4 mb-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {profileCompletion}% complete - Add more details to unlock better
                recommendations
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="p-6">
            ...
            <p className="text-xs text-muted-foreground">Counted from applications</p>
          </Card>
          ...
          <Card className="p-6">
            ...
            <div className="text-3xl mb-1">{stats.skills}</div>
